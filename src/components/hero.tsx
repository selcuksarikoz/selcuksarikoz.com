...
import { ChevronRight, Code, ExternalLink, Terminal } from "lucide-react";
...
export default function HeroSection() {
  ...
  return (
    <div
      ref={heroRef}
      className="relative min-h-screen pt-30 pb-6 flex flex-col items-center justify-center overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="container mx-auto px-6 z-10 relative flex flex-col items-center">
        {/* Developer Badge */}
        <div className="inline-flex items-center px-3 py-1 rounded-full bg-primary/10 text-primary-light border border-primary/20 text-sm font-mono mb-8">
