    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans text-gray-800">
            ...
            <section className="py-20 sm:py-28 relative overflow-hidden">
                ...
                <div
                    className="absolute right-0 top-0 w-1/3 h-1/3 bg-gradient-to-b from-blue-100 to-transparent rounded-bl-full opacity-60"></div>
                <div
                    className="absolute left-0 bottom-0 w-1/4 h-1/4 bg-gradient-to-t from-cyan-100 to-transparent rounded-tr-full opacity-60"></div>
                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:gap-8">
                        <div className="sm:text-center lg:text-left lg:col-span-6">
                            <ScrollReveal className="w-full">
                                <div
                                    className="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-medium bg-gradient-to-r from-orange-100 to-amber-100 text-orange-600 mb-8 shadow-sm">
                    ...
                    what you copy
                        ...
                        <div className="mt-16 lg:mt-0 lg:col-span-6 relative">
                            <ScrollReveal delay={300} className="w-full">
                                <div
                                    className="absolute -right-10 -top-10 w-72 h-72 bg-gradient-to-br from-blue-100 to-cyan-100 rounded-full filter blur-3xl opacity-30"></div>
                                <div
                                    className="relative mx-auto w-full bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 transform rotate-1 hover:rotate-0 transition-transform duration-700">
                                    <Image
                                        className="w-full"
                                    ...
                                    />
                                    <div
                                        className="absolute -bottom-6 -right-6 w-24 h-24 bg-gradient-to-tl from-blue-400 to-cyan-300 rounded-full filter blur-2xl opacity-20"></div>
                                </div>
                            </ScrollReveal>
                        </div>
                    </div>
            ...
            >
                <div
                    className="absolute top-0 left-0 w-full h-full bg-[url('/images/apps/pattern-grid.png')] opacity-5"></div>
                <div
                    className="absolute -left-20 top-0 w-80 h-80 bg-blue-100 rounded-full filter blur-3xl opacity-30"></div>
                <div
                    className="absolute -right-20 -bottom-20 w-80 h-80 bg-cyan-100 rounded-full filter blur-3xl opacity-30"></div>
                            ...
                            <div className="space-y-8">
                                <ScrollReveal className="w-full" delay={200}>
                                    <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-100">
                                        <div className="flex">
                                            <div
                                                className="flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-blue-100 text-blue-600">
            ...
            <section id="features" className="py-24 bg-white relative">
                <div
                    className="absolute left-0 top-1/4 w-1/3 h-1/2 bg-gradient-to-r from-blue-50 to-transparent rounded-r-full opacity-70"></div>
                <div
                    className="absolute right-0 bottom-1/4 w-1/3 h-1/2 bg-gradient-to-l from-cyan-50 to-transparent rounded-l-full opacity-70"></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                  ...
                  supercharged
                    ...
                    <div className="mt-20 grid gap-10 md:grid-cols-3">
                        {/* Feature 1 */}
                        <div
                            className="bg-gradient-to-br from-white to-blue-50 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all border border-gray-100 group hover:translate-y-[-8px] duration-300">
                            <ScrollReveal delay={150} className="w-full">
                                <div
                                    className="h-16 w-16 rounded-xl bg-gradient-to-r from-blue-400 to-blue-500 text-white flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                    <History size={28}/>
                                </div>
                        ...
                        <div
                            ...
                            <ScrollReveal delay={300} className="w-full">
                                <div
                                    className="h-16 w-16 rounded-xl bg-gradient-to-r from-cyan-400 to-blue-400 text-white flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                    <Search size={28}/>
                                </div>
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">
                        ...
                        <div
                            ...
                            <ScrollReveal delay={450} className="w-full">
                                <div
                                    className="h-16 w-16 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-400 text-white flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                                    <Clipboard size={28}/>
                                </div>
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">
                                    One-Click Access
            ...
            <section
                className="py-24 bg-gradient-to-br from-amber-50 via-orange-50 to-rose-50 relative overflow-hidden">
                <div
                    className="absolute top-0 left-0 w-full h-full bg-[url('/images/apps/pattern-dots.png')] opacity-5"></div>
                <div
                    className="absolute -right-10 -bottom-10 w-64 h-64 bg-gradient-to-tl from-amber-200 to-orange-100 rounded-full filter blur-3xl opacity-30"></div>

                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div
                        className="bg-white/80 backdrop-blur-lg shadow-2xl rounded-3xl overflow-hidden border border-orange-100">
                        <div className="md:flex">
                            <div className="md:w-1/2 p-10 md:p-16">
                                <ScrollReveal className="w-full">
                                    <div
                                        className="inline-flex items-center p-2 rounded-full bg-gradient-to-r from-orange-100 to-amber-100 mb-8">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center px-8 py-4 text-base font-medium rounded-xl text-white bg-green-600 hover:bg-green-700 shadow-lg hover:shadow-xl transition-all"
                                        style={{color: "white"}}
                                    >
                                        <Star
                                            size={20}
                            ...
                            <div
                                className="md:w-1/2 bg-gradient-to-br from-orange-50 to-amber-50 p-10 md:p-16 flex items-center justify-center relative">
                                <div
                                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-orange-200 rounded-full filter blur-3xl opacity-20"></div>
                                <ScrollReveal delay={200} className="w-full">
                                    <div
                                        className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md relative border border-orange-100 hover:translate-y-[-4px] transition-all duration-300">
                                        <div
                                            className="absolute -top-3 -right-3 bg-orange-500 text-white text-xs px-3 py-1 rounded-full font-medium">
                                            FEATURED
                                        </div>
                                        <div className="flex items-start mb-6">
                                            <div
                                                className="h-16 w-16 rounded-2xl overflow-hidden shadow-md flex-shrink-0 border border-gray-200">
                                                <Image
                                                    src="/images/apps/clipmind/clipmind.png"
                                                    alt="ClipMind"
                                        ...
                                        <div className="flex items-center justify-end">
                                            <button
                                                className="flex items-center bg-gradient-to-r from-orange-100 to-amber-100 rounded-full px-4 py-2 text-orange-600 shadow-sm hover:shadow-md transition-all">
            ...
            <section className="py-24 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    update
                                ...
                                {subscribed ? (
                                    <div
                                        className="mt-10 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 flex items-center justify-center text-green-800 border border-green-100 shadow-md">
