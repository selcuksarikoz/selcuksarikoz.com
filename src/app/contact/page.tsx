        ...
        <div className="flex flex-col gap-20 max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 pt-30">
            ...
            <div className="relative">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
                    <div
                        className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-primary/10 blur-3xl opacity-20"></div>
                    <div
                        className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-secondary/10 blur-3xl opacity-20"></div>
                </div>

                <div
                    className="bg-dark-50/70 backdrop-blur-sm rounded-2xl overflow-hidden border border-dark-100/60 shadow-xl">
                    <div className="grid md:grid-cols-5">
                        {/* Contact Information */}
                        <div
                            className="md:col-span-2 p-8 bg-gradient-to-br from-primary/5 to-secondary/5 flex flex-col justify-between relative overflow-hidden">
                            ...
                            <div className="relative">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center">
                                        <div
                                            className="h-10 w-10 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center mr-4">
                                    ...
                                    <div className="flex items-center">
                                        <div
                                            className="h-10 w-10 rounded-lg bg-secondary/10 border border-secondary/20 flex items-center justify-center mr-4">
