  ...
  return (
    <div className="w-full py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative bg-dark-50/70 backdrop-blur-sm rounded-2xl border border-dark-100/40 shadow-xl overflow-hidden">
          ...
          <div className="relative flex flex-col lg:flex-row gap-8 p-8">
            ...
            <div className="lg:w-1/3">
              <div className="relative mx-auto lg:mx-0 max-w-xs">
                {/* Image with frame */}
                <div className="relative rounded-2xl overflow-hidden border-2 border-dark-100/60 shadow-2xl">
                  ...
                  {/* Code badge */}
                  <div className="absolute top-4 right-4 bg-primary/20 backdrop-blur-sm border border-primary/30 rounded-lg py-1 px-3 text-xs font-mono text-primary-light">
              ...
              <div ref={timelineRef} className="mt-16">
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-0 flex justify-center">
                    <div className="w-1 bg-gradient-to-b from-primary/30 via-secondary/30 to-accent/30 rounded-full"></div>
                  </div>
