    ...
    return (
        <div ref={containerRef} className="flex flex-col min-h-screen pb-20 pt-30">
            <div className="max-w-7xl w-full mx-auto px-6 sm:px-8 lg:px-10">
                    ...
                    {filteredApps.map((app) => (
                        ...
                        >
                            ...
                            <div className="relative h-48 overflow-hidden">
                                ...
                                {/* Overlay */}
                                <div
                                    className="absolute inset-0 bg-gradient-to-t from-dark via-dark/50 to-transparent"></div>
                      ...
                      {tag}
                                ...
                                <div className="mt-auto relative">
                                    ...
                                    {openDropdown === app.id && (
                                        <div
                                            className="absolute z-50 mt-2 w-full rounded-lg shadow-lg bg-dark-50 border border-dark-100">
                                            <div className="py-1">
                            ...
                            <div className="absolute top-0 right-0 w-16 h-16 overflow-hidden z-[10]">
                                <div
                                    className="absolute transform rotate-45 bg-gradient-to-br from-primary/90 to-primary/90 text-white text-xs py-1 right-[-35px] top-[14px] w-[120px] text-center">
                                    App
                                </div>
                            </div>
                        </div>
                ...
                {/* Call to Action */}
                <div
                    className="mt-20 bg-gradient-to-br from-dark-50 to-dark rounded-xl border border-dark-100/60 p-8 text-center">
                    <h3 className="text-2xl font-bold text-white mb-3">
                        Looking for a Custom Solution?
                    </h3>
                    <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                        If you like my apps and need custom development work, I&#39;m available
                        for freelance projects and consulting.
                    </p>
                    <a
                        href="/contact"
