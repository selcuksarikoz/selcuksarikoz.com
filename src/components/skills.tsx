    ...
    <div className="w-full py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* Center Circle */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 rounded-full bg-dark-50 border border-primary/30 flex items-center justify-center shadow-glow z-0 animate-pulse-slow">
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-8">
          <div className="flex items-center gap-3">
            <div className="px-3 py-1.5 rounded-full bg-primary/20 text-primary-light border border-primary/30 text-sm font-mono">
              Expert
            </div>
            <span className="text-sm text-gray-400">High proficiency</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="px-3 py-1.5 rounded-full bg-secondary/20 text-secondary-light border border-secondary/30 text-sm font-mono">
              Advanced
            </div>
            <span className="text-sm text-gray-400">Strong knowledge</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="px-3 py-1.5 rounded-full bg-accent/20 text-accent-light border border-accent/30 text-sm font-mono">
              Intermediate
            </div>
